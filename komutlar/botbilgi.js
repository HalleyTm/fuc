...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@659133949876109312> \n `Ahmet2704#5890`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **09.01.2020**'de yapılmaya başlanmıştır")
    .setFooter('Ahmet2704', client.user.avatarURL)
    .setTimestamp()
