...
module.exports.run = (bot, message, args) => {
    if (channels.includes(message.channel.id)) {
        message.reply("Zaten Bir Çizim Yapılıyor!");
        return;
    }
    var size;
...
class Drawing {
    constructor(msg, size, fg, bg) {
        ...
        msg.edit("Kalemi hareket ettirmek için emojileri kullanın: \ n✅ Çizimi Bitir |  Kalem  🖋 Açık | 🔏Kapalı");
        this.reactArrows(0);
    ...
    stop(reason = "") {
        ...
        this.msg.edit("Güzel Resim Değil Mi?" + reason);
